...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: '*_✳ Este comando solo puede ser utilizado por el propietario_*',
    owner: '*_✳ Este comando solo puede ser utilizado por bots (jadibot/serbot) y el propietario_*',
    mods: '*_✳ Este comando solo puede ser utilizado por moderadores y propietario del Bot_*',
    premium: '*_✳ Este pedido es solo para miembros premium_*',
    group: '*_✳ ¡Este comando solo se puede usar en grupos!_*',
    private: '*_✳ Este comando solo se puede usar en el chat privado!_*',
    admin: '*_✳️ Este comando es solo para Admins del grupo_*',
    botAdmin: '*_✳ Ascender el Bot como Admin para usar este comando!_*',
    unreg: '*_⚠️ Regístrese para utilizar esta función escribiendo:_*\n\n*_#registrar nombre.edad_*\n\n*_Ejemplo:_*\n*_#registrar Shadow.18_*\n\n*_Este registro se solicita con el fin de que el Bot no se sature_*\n\nNota: No escriba los "*" ni los "_"\n\n*Nota: El registro fue quitado, si algun comando le pide registro favor de reportarlo*'
  }[type]
